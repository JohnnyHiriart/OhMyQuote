    ...
    <div className="flex flex-col w-full justify-center h-[50vh] items-center text-[#dbe4ee]">
      ...
      <Link to={isActiveSlide1 && "/category"}>
        ...
        : "shadow-shadowcarousel1 cursor-pointer h-80 w-16 rounded-[2rem] m-2 bg-[end] bg-no-repeat bg-cover overflow-hidden transition-[width] duration-200 ease-linear"
          ...
          onClick={!isActiveSlide1 && handleClickActiveSlide1}>
              <div className="flex w-[1000rem]">
                <div className="shadow-shadowcarousel1 bg-white w-10 h-10 m-[0.7rem] rounded-[50%] flex justify-center items-center">
                  <img className="w-1/2" src="../src/assets/smal-logo-oh-my-quote.png" alt="logoohmyquote" />
                </div>
                <div className={isActiveSlide1
          ...
          onClick={!isActiveSlide1 && handleClickActiveSlide1}>
                  <h4 className="text-[1.5rem] drop-shadow-[0_1px_1px_black] [line-height:0.9rem]">Categories</h4>
                  <p className="text-[1.1rem] drop-shadow-[0_1px_1px_black] [line-height:2.5rem]">Choose the theme of your quote</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <Link to={isActiveSlide2 && "/quote-me"}>
        ...
        : "shadow-shadowcarousel1 cursor-pointer h-80 w-16 rounded-[2rem] m-2 bg-[end] bg-no-repeat bg-cover overflow-hidden transition-[width] duration-200 ease-linear"
          ...
          onClick={!isActiveSlide2 && handleClickActiveSlide2}>
              <div className="flex w-[1000rem]">
                <div className="shadow-shadowcarousel1 bg-white w-10 h-10 m-[0.7rem] rounded-[50%] flex justify-center items-center">
                <svg className="text-redquote fill-current w-1/2" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M0 416C0 398.3 14.33 384 32 384H86.66C99 355.7 127.2 336 160 336C192.8 336 220.1 355.7 233.3 384H480C497.7 384 512 398.3 512 416C512 433.7 497.7 448 480 448H233.3C220.1 476.3 192.8 496 160 496C127.2 496 99 476.3 86.66 448H32C14.33 448 0 433.7 0 416V416zM192 416C192 398.3 177.7 384 160 384C142.3 384 128 398.3 128 416C128 433.7 142.3 448 160 448C177.7 448 192 433.7 192 416zM352 176C384.8 176 412.1 195.7 425.3 224H480C497.7 224 512 238.3 512 256C512 273.7 497.7 288 480 288H425.3C412.1 316.3 384.8 336 352 336C319.2 336 291 316.3 278.7 288H32C14.33 288 0 273.7 0 256C0 238.3 14.33 224 32 224H278.7C291 195.7 319.2 176 352 176zM384 256C384 238.3 369.7 224 352 224C334.3 224 320 238.3 320 256C320 273.7 334.3 288 352 288C369.7 288 384 273.7 384 256zM480 64C497.7 64 512 78.33 512 96C512 113.7 497.7 128 480 128H265.3C252.1 156.3 224.8 176 192 176C159.2 176 131 156.3 118.7 128H32C14.33 128 0 113.7 0 96C0 78.33 14.33 64 32 64H118.7C131 35.75 159.2 16 192 16C224.8 16 252.1 35.75 265.3 64H480zM160 96C160 113.7 174.3 128 192 128C209.7 128 224 113.7 224 96C224 78.33 209.7 64 192 64C174.3 64 160 78.33 160 96z"/></svg>
                </div>
                <div className={isActiveSlide2
            ? "opacity-100 ml-0 mt-3 transition-[all] duration-200 ease-linear text-white"
            : "mt-3 ml-4 transition-[all] duration-200 ease-linear text-white opacity-0"
          ...
          onClick={!isActiveSlide2 && handleClickActiveSlide2}>
                  <h4 className="text-[1.5rem] drop-shadow-[0_1px_1px_black] [line-height:0.9rem]">Quote Me</h4>
                  <p className="text-[1.1rem] drop-shadow-[0_1px_1px_black] [line-height:2.5rem]">Edit and share your quote</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <Link to={isActiveSlide3 && "/top-quotes"}>
        <div className={isActiveSlide3
        ? "shadow-shadowcarousel1 cursor-pointer h-80 rounded-[2rem] m-2 bg-[end] bg-no-repeat bg-cover overflow-hidden transition-[width] duration-200 ease-linear w-[30rem]"
        : "shadow-shadowcarousel1 cursor-pointer h-80 w-16 rounded-[2rem] m-2 bg-[end] bg-no-repeat bg-cover overflow-hidden transition-[width] duration-200 ease-linear"
      } 
          onClick={!isActiveSlide3 && handleClickActiveSlide3}>
          <div
            className={isActiveSlide3
          ...
          onClick={!isActiveSlide3 && handleClickActiveSlide3}>
                  <h4 className="text-[1.5rem] drop-shadow-[0_1px_1px_black] [line-height:0.9rem]">Top Quotes</h4>
                  <p className="text-[1.1rem] drop-shadow-[0_1px_1px_black] [line-height:2.5rem]">Your favorite quotes</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <Link to={isActiveSlide4 && "/the-crew"}>
        <div className={isActiveSlide4
        ? "shadow-shadowcarousel1 cursor-pointer h-80 rounded-[2rem] m-2 bg-[end] bg-no-repeat bg-cover overflow-hidden transition-[width] duration-200 ease-linear w-[30rem]"
        : "shadow-shadowcarousel1 cursor-pointer h-80 w-16 rounded-[2rem] m-2 bg-[end] bg-no-repeat bg-cover overflow-hidden transition-[width] duration-200 ease-linear"
      } 
          onClick={!isActiveSlide4 && handleClickActiveSlide4}>
          <div
            className={isActiveSlide4
          ...
          onClick={!isActiveSlide4 && handleClickActiveSlide4}>
                  <h4 className="text-[1.5rem] drop-shadow-[0_1px_1px_black] [line-height:0.9rem]">The Crew</h4>
                  <p className="text-[1.1rem] drop-shadow-[0_1px_1px_black] [line-height:2.5rem]">Know us and contact us</p>
                </div>
              </div>
            </div>
          </div>
