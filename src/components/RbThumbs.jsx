...
const RbThumbs = () => {
  return (
    <div className="flex items-center content-center justify-center pt-10 m-2 ">
      <div className="flex items-center justify-center text-4xl font-bold text-white rounded-full h-14 bg-redquote w-14">
        1
      </div>
      <div className="flex content-center justify-center w-3/4 m-2 border-8 rounded-xl border-redquote bg-redquote bg-opacity-5">
        {/* box with quote */}
