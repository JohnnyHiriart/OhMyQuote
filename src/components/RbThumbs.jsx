...
const RbThumbs = ({ nbr, quote, setQuote }) => {
  return (
    <Link to="/quote-me">
      <div className="flex items-center content-center justify-center m-10">
        ...
        <div
          className="flex justify-between w-3/5 border-4 rounded-lg hover:scale-125 hover:ml-16 border-redquote bg-redquote bg-opacity-5"
